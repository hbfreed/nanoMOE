...
if real_data:
    ...
    x = torch.randint(50304, (batch_size, n_ctx), device=device)
    y = torch.randint(50304, (batch_size, n_ctx), device=device)
    get_batch = lambda split: (x, y)

# model init
gptconf = GPTConfig(
    n_ctx = n_ctx, # how far back does the model look? i.e. context size
